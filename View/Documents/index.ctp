<div class="documents index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('invent');?></th>
			<th><?php echo $this->Paginator->sort('colloc');?></th>
	...
	<tr>
		<td><?php echo h($document['Document']['codice']); ?>&nbsp;</td>
		<td><?php echo h($document['Document']['desc_it']); ?>&nbsp;</td>
		<td><?php echo h($document['Document']['desc_en']); ?>&nbsp;</td>
		<td><?php echo h($document['Document']['invent']); ?>&nbsp;</td>
		<td><?php echo h($document['Document']['colloc']); ?>&nbsp;</td>
		<td class="actions">
