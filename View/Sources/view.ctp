...
<h2><?php  echo __('Source');?></h2>
	<dl>
		...
		<dd>
			<?php echo h($source['Source']['codice']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Desc It'); ?></dt>
		<dd>
			<?php echo h($source['Source']['desc_it']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Desc En'); ?></dt>
		<dd>
			<?php echo h($source['Source']['desc_en']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Tt'); ?></dt>
		<dd>
			<?php echo h($source['Source']['tt']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Act'); ?></dt>
		<dd>
			<?php echo h($source['Source']['act']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
